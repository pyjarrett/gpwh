...
main = do
    ...
    let start = Map.lookup startingInput locationDB 
    let destination = Map.lookup destinationInput locationDB
    printDistance (haversine <$> start <*> destination)
